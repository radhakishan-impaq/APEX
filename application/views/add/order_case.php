    ...
    <div class="col-md-12">
        ...
        <?php } ?>
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject font-green-haze bold uppercase">CASE Order</span>
            ...
            <div class="portlet-body form">
                <?php
                    ...
                    echo form_open_multipart(base_url('order/case_order'), $attributes);
                ?>
            ...
            <div class="portlet-title"> 
                <div class="actions">
                    <div class="btn-group">
                        <a class="btn green-haze btn-outline btn-circle btn-sm" href="<?php echo base_url('order/add/'.$fetch_case[0]['id']); ?>" > Add Case Order
                        </a>
                    </div>
                </div>
                </div> 
                ...
                <table class="table table-striped table-bordered table-advance table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url('order/edit/'.$d['case_order_id']) ?>"><button type="button" class="btn btn-success">Edit File</button></a>

                                <?=anchor("order/delete/".$d['case_order_id'],"Delete",array("onclick" => "return confirm('Do you really want to delete this record')", "class" => "btn btn-danger"))?>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
            ...
            <?php } else { ?>
            <h3>No Case Order Record Found.</h3>
            <?php } } else { ?>
            <div class="alert alert-danger">
