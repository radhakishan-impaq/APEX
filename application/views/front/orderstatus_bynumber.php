        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Search order By Number</span>
            ...
            <div class="portlet-body form">
               ...
               <?php
                    ...
                    echo form_open_multipart(base_url('orderstatus/bynumber'), $attributes);
                ?>
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="regular_number" id="regular_number" class="form-control" value="<?php echo $this->input->post('regular_number'); ?>" placeholder="Enter Regular Number">
                            </div>
                        </div>
    ...
    $(document).ready(function () {
        $("#add").validate({
            ...
            messages: {
                ...
                'regular_number': "<span style='color: #FF0000;'>Please Enter Regular Number</span>",
