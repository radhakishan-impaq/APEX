        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                <?php
                    ...
                    echo form_open_multipart(base_url('advocate/edit/'.$id), $attributes);
                ?>
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="advocate_name" name="advocate_name" placeholder="Advocate Name" required value="<?php echo $detail[0]['advocate_name']; ?>">
                            </div>
                        </div>
