        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
               ...
               <?php
                    ...
                    echo form_open_multipart(base_url('casetype/add'), $attributes);
                ?>
                <?php echo validation_errors(); ?>
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="case_name" name="case_name" placeholder="Case Name" required>
                            </div>
                        </div>
