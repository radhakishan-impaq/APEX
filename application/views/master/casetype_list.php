<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-green-haze bold uppercase">Case Type</span>
                <span class="caption-helper">List</span>
            </div>
            <div class="actions">
                <div class="btn-group">
                    <a class="btn green-haze btn-outline  btn-circle btn-sm" href="<?php echo base_url('casetype/add'); ?>" > Add Case Types
                    </a> 
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    $('#item_list').DataTable({
        "ajax": {
            url : "<?php echo site_url("casetype/ajaxlist") ?>",
            type : 'GET'
        },
    });     
});
