        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
               ...
               <?php
                    ...
                    echo form_open_multipart(base_url('cause/edit/'.$id), $attributes);
                ?>
                <?php echo validation_errors(); ?>
                <input type="hidden" name="filename" id="filename" value="<?php echo $detail[0]['cause_list_pdf']; ?>">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <label id="label" for="file-upload" class="custom-file-upload form-control">
                                    ...
                                    <?php if(!$detail) { echo "Upload File"; } else { echo $detail[0]['cause_list_pdf']; } ?>
                                </label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                            <input type="text" name="date" id="date" class="form-control datepicker" value="<?php echo $detail[0]['date']; ?>" readonly placeholder="yyyy-mm-dd">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
