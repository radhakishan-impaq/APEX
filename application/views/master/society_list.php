<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-green-haze bold uppercase">Society</span>
                <span class="caption-helper">List</span>
            </div>
            <div class="actions">
                <div class="btn-group">
                    <a class="btn green-haze btn-outline btn-circle btn-sm" href="<?php echo base_url('society/add'); ?>" > Add Society
                    </a>
                </div>
            </div>
        </div>
                ...
                <table class="table table-striped table-bordered table-advance table-hover" id="item_list">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <i class="fa"></i><b> Secretary Name </b>
                            </th>
                            <th>
...
$(document).ready(function() {
    $('#item_list').DataTable({
        "ajax": {
            url : "<?php echo site_url("society/ajaxlist") ?>",
            type : 'GET'
        },
    });     
});
