<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-green-haze bold uppercase">User</span>
                <span class="caption-helper">List</span>
            </div>
            <div class="actions">
                <div class="btn-group">
                    <a class="btn green-haze btn-outline btn-circle btn-sm" href="<?php echo base_url('user/add'); ?>" > Add User
                    </a>
                </div>
            </div>
        </div>
