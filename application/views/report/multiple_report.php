        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <?php
                    ...
                    echo form_open_multipart(base_url('report/multiple_report'), $attributes);
                ?>
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Repondent Name :</label>
                            <div class="col-md-4">
                                <select name="respondent" id="respondent" class="form-control">
                                    <option value="">Select</option>
                                    <?php foreach($respondent as $a) { ?>
                                    <option value="<?php echo $a['respondent_name']; ?>" <?php echo $this->input->post('respondent')==$a['respondent_name']?'selected':''; ?>><?php echo $a['respondent_name']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
    ...
    $(document).ready(function () {
        $("#report").validate({
            ...
            messages: {
                ...
                'respondent': "<span style='color: #FF0000;'>Please Select Respondent Name</span>",
