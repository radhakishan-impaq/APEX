    ...
    <div class="col-md-12">
        ...
        <?php } ?>
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject font-green-haze bold uppercase">Directive</span>
            ...
            <div class="portlet-body form">
                <?php
                    ...
                    echo form_open_multipart(base_url('directive/search_directive'), $attributes);
                ?>
                    <div class="form-body">
            ...
            <div class="portlet-title">
                <div class="actions">
                    <div class="btn-group">
                        <a class="btn green-haze btn-outline btn-circle btn-sm" href="<?php echo base_url('directive/add/'.$fetch_case[0]['id']); ?>" > Add Directive
                        </a>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-striped table-bordered table-advance table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $d['d_status']; ?></td>

                            <td>
                                <a href="<?php echo base_url('directive/edit/'.$d['directive_id']) ?>"><button type="button" class="btn btn-success">Edit </button></a>
                                <!-- <a href="<?php echo base_url('directive/delete/'.$d['directive_id']) ?>"><button type="button" class="btn btn-danger">Delete File</button></a> -->
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
            ...
            <?php } else { ?>
            <h3>No Directive Record Found.</h3>
            <?php } } else { ?>
            <div class="alert alert-danger">
